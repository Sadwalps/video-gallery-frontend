...
import { deleteEducationTutorialAPI, getEducationTutorialAPI } from './service/allApi';
...
function EducationAndTutorials() {
  ...
  const handleDelete = async (id) => {
    const result = await deleteEducationTutorialAPI(id)
  ...
  return (
    <>
      <div className='videopages'>
        ...
        {educationTutorial?.length > 0 ? <div className='container-fluid pb-5' style={{minHeight:"75vh"}}>
          <div className="row">
