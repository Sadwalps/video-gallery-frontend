...
import { deleteGamingHighlightsAPI, getGamingHighlightsAPI } from './service/allApi';
...
function GamingHighlight() {
  ...
  const handleDelete = async (id) => {
    const result = await deleteGamingHighlightsAPI(id)
    console.log(result);
  ...
  return (
    <>
      <div className='videopages'>
        ...
        {gaminghighlights?.length > 0 ? <div className='container-fluid pb-5' style={{minHeight:"75vh"}}>
          <div className="row">
